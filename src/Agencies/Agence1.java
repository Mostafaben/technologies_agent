...
public class Agence1 extends Agent {

    private ACLMessage sentMessage;
    private int red_dehos_estivale = 20;
    private int red_enf_7 = 30;
    private int red_7_11 = 30;
    private int red_sup75 = 30;
    private int red_plus4;

    private ArrayList<String> flightsList = new ArrayList<String>();

    protected void setup() {
        if (this.getLocalName().equals("Agence1")) {
                    ...
                    if (msg.getContent() != null) {
                        ...
                        try {
                            ...
                            while (scanner.hasNextLine()) {
                                flightsList.add(scanner.nextLine());
                            }
                            scanner.close();
                        ...
                        if (input[4].equals("null") && input[5].equals("unspecified")
                            ...
                            for (String vol : flightsList) {
                                ...
                                volsRetournes.add(vol + " " + total + " A1");
